    ...
    <form onSubmit={handleDataSubmit}>
      <section className="bg-gray-50 dark:bg-gray-900">
        <EditForm formMessage="Create event">
          ...
          <InputField id="description" name="Description" type="text" placeholder="Interesting even description" data={data} setData={setData} errors={errors} setErrors={setErrors}>
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <InputField id="poster" name="Poster?" type="text" placeholder="bidlo" data={data} setData={setData} errors={errors} setErrors={setErrors}>
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
