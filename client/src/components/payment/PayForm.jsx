	...
	<div>
			<div className="min-w-screen min-h-screen  flex items-center justify-center px-5 pb-10 pt-16">
                       ...
                       <img src="https://free-png.ru/wp-content/uploads/2022/06/free-png.ru-441.png"></img>
							...
							<div className="mb-10">
									<h1 className="text-center font-bold text-xl uppercase">who launched the balls</h1>
							</div>
							<div className=" mb-10">
									<h1 class="leftstr-na " >Описание:</h1> 
                  <p class="rightstr" >Iphone 6 na mazy: </p>
                  
							</div>
							<div className="mb-10">
              <h1 class="leftstr-na " >Всего:</h1> 
                  <p class="rightstr price" >18 UAH</p>
							</div>
              ...
              <div className="card-plus">
                ...
                <div className="card-div">
                  ...
                  <div class="grid gap-6 mb-6 lg:grid-cols-2">
                    <div>
                      <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Номер карты:</label>
                      <input type="text" id="first_name" class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="XXXX XXXX XXXX XXXX" required/>
                    </div>
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Срок действия:</label>
                        <input type="text" id="last_name" class="w-32 px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="MM/ГГ" required/> 
                    </div>
                  </div>
                  </div>
                  <div classname="mb-10">
                ...
                <div class="email-phone-div grid gap-6 mb-6 lg:grid-cols-2">
                  <div>
      ...
      <div class="footer footer-center  w-full p-4 bg-gray-300 text-gray-800">
