        ...
        <EditForm formMessage="Sign in">
          ...
          >
            <div className="absolute inset-y-0 left-0 flex items-center pl-1 pointer-events-none">
              <svg
                aria-hidden="true"
                className="w-5 h-5 text-gray-500 dark:text-dark-text-400"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  type="checkbox"
                  className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-0 focus:ring-transparent dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-transparent dark:ring-offset-gray-800"
                  required=""
                />
              </div>
