        ...
        <div className=" product-image-wrapper" >
          <div className="single-products">
            ...
            <div className="productinfo text-center">
              <img src="/1.jpg" alt="" />
              <p className='name'>Name Huame kokoname</p>
          ...
          <div className="choose">
            <ul className="nav nav-pills nav-justified">
              ...
              <div className=" bl1 start flex   ">
                ...
                <a className="text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:sm:text-white" >&nbsp; 24 Февраля </a>
              </div>
                <div className=" bl1 start flex   ">
              ...
              <div className=" bl1 start flex   ">
                ...
                <a className="text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:sm:text-white" >&nbsp; Łwow </a>
              </div>
              <div className=" bl1 start flex   ">
                ...
                <a className="text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:sm:text-white" >&nbsp; 600 - 200 ₴ </a>
              </div>
            </ul>
            
              {/* button buy */}
              <div className=''>
                <a href="/MainItem" className="">
