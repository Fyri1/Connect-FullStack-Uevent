    ...
    <div className=" main-div-MainItem py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div className="info-ticket-div max-w-4xl mx-auto  lg:max-w-6xl lg:gap-x-20 lg:grid-cols-2">
        <div className="">
          ...
          {/* Event name */}
          <h1 className="mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-2xl dark:sm:text-white">Ticket to Poland</h1>
          ...
          <div className="text-indigo-600 flex items-center dark:text-indigo-400">
            ...
            <a className="text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:sm:text-white">Tickets left: 1488</a>
          </div>
