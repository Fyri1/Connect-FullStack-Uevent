        ...
        <a>&nbsp;</a>
         {/* start biographies  */}
          ...
          <div className='lin2 back-fon-biographies'>
            <div class=" md:flex shadow-lg   h-64">
              <img class=" object-cover rounded-lg rounded-r-none " src="https://ik.imagekit.io/q5edmtudmz/FB_IMG_15658659197157667_wOd8n5yFyXI.jpg" alt="bag"/>
              <div class=" child px-4 py-4 bg-white rounded-lg">
                  ...
                  <button class="mt-20 w-full border p-2 bg-gradient-to-r from-gray-800 bg-gray-500 text-white rounded-[4px] hover:bg-slate-400 " type="submit">Развернуть</button>
