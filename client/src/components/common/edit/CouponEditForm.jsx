...
const CouponEditForm = ({ originData, formMessage }) => {
  ...
  const promocodes = originData?.id ? usePromoCodes(originData.id) : [];
      ...
      <div className="w-full bg-transparent">
        <div className="w-full bg-white rounded-lg shadow dark:border dark:bg-dark-bg-800 dark:border-dark-bg-700">
          <div className="p-6 space-y-4">
            ...
            <InputField id="duration" name="Duration (in month)" type="number" min={0} data={data} setData={setData} errors={errors} setErrors={setErrors}>
              <div className="absolute inset-y-0 left-0 flex items-center pl-1 pointer-events-none">
            ...
            <div className="inline-flex items-center justify-center w-full">
              ...
              <span className="absolute px-3 text-base text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-dark-text-400 dark:bg-dark-bg-800">
                Promocodes:
              </span>
            </div>
