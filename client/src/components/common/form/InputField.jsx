...
const InputField = ({ id, name, type, data, setData, errors, setErrors, children }) => {
  ...
  return (
    <div>
      <div data-popover-target={"error-" + id} data-popover-placement="right" data-popover-trigger="none" className="relative z-0 w-full mb-6 group">
        { children }
      ...
      <ErrorPopover id={"error-" + id} errorTitle={"Oops! " + errors[id]} errorDescription={errors[id]} />
    </div>
  );
};
