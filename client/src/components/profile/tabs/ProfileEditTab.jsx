  ...
  return (
    <div className="flex bg-white rounded-lg">
      ...
      <div className="border-b w-40 border-gray-200 dark:border-gray-700">
        <ul className="-mb-px text-sm font-medium text-left" id="myTab2" data-tabs-toggle="myTabContent2" role="tablist">
      ...
      {/* Tabs temselves */}
      <div id="myTabContent2" className="items-center justify-center w-full h-full">
