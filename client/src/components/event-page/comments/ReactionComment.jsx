...
const ReactionComment = ({ commentId, data, currentUser }) => {
  ...
  return (
    <div className="flex">
      <ReactionElement
        reactionClickHandle={likeButtonClickHandle}
        isActive={activeReactions.like}
        reactionAmount={reaction.like}
      >
      ...
      <ReactionElement
        reactionClickHandle={dislikeButtonClickHandle}
        isActive={activeReactions.dislike}
        reactionAmount={reaction.dislike}
      >
