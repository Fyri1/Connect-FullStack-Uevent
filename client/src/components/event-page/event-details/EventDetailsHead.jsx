  ...
  return (
    <div>
      ...
      <div className="start flex">
        ...
        <p className="pl-2 dark:text-dark-text-400">{ eventData.city }</p>
      </div>
      ...
      <div className="pb-1 text-indigo-600 flex items-center dark:text-indigo-400">
        ...
        <p className="pl-2 text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:text-dark-text-300">{t('eventDetails.ticketsLeft')} 1488</p>
      </div>
    </div>
  )
}
